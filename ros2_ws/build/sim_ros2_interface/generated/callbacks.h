...
void write__sensor_msgs__msg__JointState(const sensor_msgs::msg::JointState& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__sensor_msgs__msg__JointState(int stack, sensor_msgs::msg::JointState *msg, const ROS2ReadOptions *opt = NULL);
