    ...
    else if(publisherProxy->topicType == "sensor_msgs/msg/JointState")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<sensor_msgs::msg::JointState> > >(publisherProxy->publisher);
        sensor_msgs::msg::JointState msg;
        read__sensor_msgs__msg__JointState(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
